	...
	<div style="width: 600px">
		...
		<form action="${ctx }/user/logon" method="get">
			<table>
				<tr>
					<td width="80">用户名：</td>
					<td><input id="username" name="username" value="zhouheng" style="width: 100px" /></td>
				</tr>
				<tr>
					<td>密码：</td>
					<td><input id="password" name="password" value="zhouheng" type="password" style="width: 100px" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>
