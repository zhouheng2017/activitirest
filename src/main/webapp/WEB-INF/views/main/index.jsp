        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse">
                <ul class="nav">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#"><i
                                class="icon-th-large icon-black"></i>REST<b class="caret"></b></a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <%--<li><a href="${ctx}/chapter20/model/list">模型列表（在线设计流程）</a></li>--%>
                            <li><a href="#" rel="chapter20/model/list">模型列表（在线设计流程）</a></li>

                            <li><a href="${ctx}/diagram-viewer/index.html?processDefinitionId=Leave:1:70004&processInstanceId=105001">diagram</a></li>
