 ...
 */
public class LeaderAttributeFinderModule extends AttributeFinderModule {

    private URI defaultSubjectId;

    public LeaderAttributeFinderModule() {
...
//            attributeValues.add(new StringAttribute("Manager"));
//            attributeValues.add(new StringAttribute("ms"));
    ...
    private String findRole(String userName){
        ...
        if(userName.equals("zhouheng")){
            return "organizationRichfitOperator";
        } else if(userName.equals("zhouheng2")){
            return "organizationChangqingOperator";
        } else if(userName.equals("lily")){
            return "CNPC";
        }else if(userName.equals("andy")){
            return "organizationRichfitExaminer";
        }else if(userName.equals("kermit")){
            return "organizationChangqingExaminer";
        }
        /*else if(userName.equals("jhon")){
            return "organizationChangqingExaminer";
        }*/
