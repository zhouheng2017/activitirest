 ...
 */
public class LeaderResourceFinder extends ResourceFinderModule {
...
/*                set.add(Balana.getInstance().getAttributeFactory().createValue(new URI(DATA_TYPE), "role:role_name:manager"));
                ...
                set.add(Balana.getInstance().getAttributeFactory().createValue(new URI(DATA_TYPE), "RichfitOperator"));
                set.add(Balana.getInstance().getAttributeFactory().createValue(new URI(DATA_TYPE), "ChangqingOperator"));
